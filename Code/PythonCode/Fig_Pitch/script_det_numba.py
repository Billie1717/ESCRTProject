...
class Params(NamedTuple):
    ...
    replicas: int = 100  # number of simulations to average over
    ...
    pitch1: float = 1.0
    pitch2: float = 1.5
    BindMem0: float = -0.8 #new for new mem eq
    BindMem1: float = -2.5 #new for new mem eq
    BindMem2: float = -9.5
...
def simulate(
    ...
    BindFil1 = 0.0#-2.5 - BindMem1  # -0.345
